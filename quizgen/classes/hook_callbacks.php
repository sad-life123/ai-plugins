...
/**
 * Hook callbacks for the quizgen AI Placement.
 *
...
class hook_callbacks {
    ...
    public static function before_footer_html_generation(before_footer_html_generation $hook): void {
        \aiplacement_quizgen\output\quizgen_ui::load_quizgen_ui($hook);
    }
    ...
    public static function after_http_headers(after_http_headers $hook): void {
        \aiplacement_quizgen\output\quizgen_ui::action_buttons_handler($hook);
    }
}
