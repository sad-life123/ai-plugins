/chat/ - useless unchecked
basic embedded chat into courses..... 

/quizgen/ - useless unchecked
basic question generator based on IDK ...

/textprocessor/ - atleast it loads, must be updated, ollama connection failed on local machine.
